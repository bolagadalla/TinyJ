...
public final class TJ {
  ...
  // This is the data memory location
  public static final int data[] = new int [DATA_MEMORY_SIZE]; /* space for static variables,   */
                                                               /* string literals, stackframes, */
                                                               /* and the heap                  */
  // This represents code that is generated and will be executed
  // Doing generatedCode.get(a) will return the instruction stored in the code memory address at a
